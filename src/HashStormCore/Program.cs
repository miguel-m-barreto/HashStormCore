...
using HashStormCore.Crypto.Hashing.Ethash.Etchash;
using HashStormCore.Crypto.Hashing.Ethash.Ethash;
using HashStormCore.Crypto.Hashing.Ethash.Ethashb3;
using HashStormCore.Crypto.Hashing.Ethash.Ubqhash;
using HashStormCore.Crypto.Hashing.Progpow.Firopow;
using HashStormCore.Crypto.Hashing.Progpow.Kawpow;
using HashStormCore.Crypto.Hashing.Progpow.Meowpow;
using HashStormCore.Crypto.Hashing.Progpow.Merakipow;
...
using HashStormCore.Persistence.Dummy;
...
[assembly: InternalsVisibleToAttribute("HashStormCore.Tests")]
...
public class Program : BackgroundService
{
    ...
    private static void ValidateRuntimeEnvironment()
    {
        ...
        if (RuntimeInformation.IsOSPlatform(OSPlatform.Windows) && RuntimeInformation.ProcessArchitecture == Architecture.X86)
            throw new PoolStartupException("HashStormCore requires 64-Bit Windows");
    }
...
╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝╚══════╝   ╚═╝    ╚═════╝ ╚═╝  ╚═╝╚═╝     ╚═╝
              ...
              HashStormCore - MiningCore technical successor
");
        Console.WriteLine("https://github.com/miguel-m-barreto/HashStormCore");
        Console.WriteLine("Based on: https://github.com/coinfoundry/miningcore");
        /*
    ...
    private static async Task PreFlightChecks(IServiceProvider services)
    {
        ...
        // Configure Ethhash
        HashStormCore.Crypto.Hashing.Ethash.Ethash.Cache.messageBus = messageBus;

        // Configure Etchash
        HashStormCore.Crypto.Hashing.Ethash.Etchash.Cache.messageBus = messageBus;

        // Configure Ethashb3
        HashStormCore.Crypto.Hashing.Ethash.Ethashb3.Cache.messageBus = messageBus;

        // Configure Ubqhash
        HashStormCore.Crypto.Hashing.Ethash.Ubqhash.Cache.messageBus = messageBus;
        ...
        // Configure NexaPow
        HashStormCore.Crypto.Hashing.Algorithms.NexaPow.messageBus = messageBus;
        ...
        // Configure Firopow
        HashStormCore.Crypto.Hashing.Progpow.Firopow.Cache.messageBus = messageBus;

        // Configure Kawpow
        HashStormCore.Crypto.Hashing.Progpow.Kawpow.Cache.messageBus = messageBus;

        // Configure Meowpow
        HashStormCore.Crypto.Hashing.Progpow.Meowpow.Cache.messageBus = messageBus;

        // Configure Merakipow
        HashStormCore.Crypto.Hashing.Progpow.Merakipow.Cache.messageBus = messageBus;

        // Configure Phihash
        HashStormCore.Crypto.Hashing.Progpow.Phihash.Cache.messageBus = messageBus;

        // Configure ProgpowZ
        HashStormCore.Crypto.Hashing.Progpow.ProgpowZ.Cache.messageBus = messageBus;

        // Configure SccPow
        HashStormCore.Crypto.Hashing.Progpow.Sccpow.Cache.messageBus = messageBus;
    }
    ...
    private static async Task ConfigurePostgresCompatibilityOptions(IServiceProvider services)
    {
        ...
        if (!clusterConfig.Persistence.Postgres.EnableLegacyTimestamps.HasValue)
        {
            ...
            if (columnType != null)
                ...
                logger.Warn(() => "Unable to auto-detect Npgsql Legacy Timestamp Behavior. Please set 'EnableLegacyTimestamps' in your HashStormCore database configuration to 'true' or 'false' to bypass auto-detection in case of problems");
        }
