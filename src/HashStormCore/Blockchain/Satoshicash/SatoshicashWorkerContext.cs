...
public class SatoshicashWorkerContext : WorkerContextBase
{
    /// <summary>
    ...
    /// </summary>
    public Queue<SatoshicashJob> validJobs { get; private set; } = new();

    public virtual void AddJob(SatoshicashJob job, int maxActiveJobs)
    {
    ...
    public SatoshicashJob GetJob(string jobId)
    {
