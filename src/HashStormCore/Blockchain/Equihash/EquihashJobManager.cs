// src/HashStormCore/Blockchain/Equihash/EquihashJobManager.cs
...
namespace HashStormCore.Blockchain.Equihash;
...
public class EquihashJobManager : BitcoinJobManagerBase<EquihashJob>
{
        ...
        object submission, CancellationToken ct)
    {
        ...
        var extraNonce2 = ReadSubmitString(submitParams, 3);
        var solution = ReadSubmitString(submitParams, 4);
