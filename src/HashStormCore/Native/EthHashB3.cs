...
public static unsafe class EthHashB3
{
    ...
    [DllImport("libethhashb3", EntryPoint = "ethash_light_new_export", CallingConvention = CallingConvention.Cdecl)]
    ...
    [DllImport("libethhashb3", EntryPoint = "ethash_light_delete_export", CallingConvention = CallingConvention.Cdecl)]
    ...
    [DllImport("libethhashb3", EntryPoint = "ethash_light_compute_export", CallingConvention = CallingConvention.Cdecl)]
    ...
    /// </param>
    /// <returns></returns>
    [DllImport("libethhashb3", EntryPoint = "ethash_full_new_export", CallingConvention = CallingConvention.Cdecl)]
    ...
    [DllImport("libethhashb3", EntryPoint = "ethash_full_delete_export", CallingConvention = CallingConvention.Cdecl)]
    ...
    /// <param name="nonce">The nonce to pack into the mix</param>
    /// <returns>an object of ethash_return_value_t holding the return values</returns>
    [DllImport("libethhashb3", EntryPoint = "ethash_full_compute_export", CallingConvention = CallingConvention.Cdecl)]
    ...
    /// </summary>
    /// <param name="handle">The full handler to free</param>
    [DllImport("libethhashb3", EntryPoint = "ethash_full_dag_export", CallingConvention = CallingConvention.Cdecl)]
    ...
    /// </summary>
    /// <param name="handle">The full handler to free</param>
    [DllImport("libethhashb3", EntryPoint = "ethash_full_dag_size_export", CallingConvention = CallingConvention.Cdecl)]
    ...
    /// </summary>
    /// <param name="handle">The full handler to free</param>
    [DllImport("libethhashb3", EntryPoint = "ethash_get_seedhash_export", CallingConvention = CallingConvention.Cdecl)]
    public static extern ethash_h256_t ethash_get_seedhash(ulong block_number);

    /// <summary>
    /// Get the default DAG directory
    /// </summary>
    [DllImport("libethhashb3", EntryPoint = "ethash_get_default_dirname_export", CallingConvention = CallingConvention.Cdecl)]
