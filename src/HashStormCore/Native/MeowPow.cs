...
public static unsafe class MeowPow
{
    [DllImport("libmeowpow", EntryPoint = "ethash_create_epoch_context", CallingConvention = CallingConvention.Cdecl)]
    public static extern IntPtr CreateContext(int epoch_number);

    [DllImport("libmeowpow", EntryPoint = "ethash_destroy_epoch_context", CallingConvention = CallingConvention.Cdecl)]
    public static extern void DestroyContext(IntPtr context);

    [DllImport("libmeowpow", EntryPoint = "hash", CallingConvention = CallingConvention.Cdecl)]
    public static extern Ethash_result hash(IntPtr context, int block_number, ref Ethash_hash256 header_hash, ulong nonce);

    [DllImport("libmeowpow", EntryPoint = "ethash_calculate_epoch_seed", CallingConvention = CallingConvention.Cdecl)]
