...
public static unsafe class RandomXSCash
{
    ...
    [DllImport("librandomxscash", EntryPoint = "randomx_get_flags", CallingConvention = CallingConvention.Cdecl)]
    private static extern RandomX.randomx_flags randomx_get_flags();

    [DllImport("librandomxscash", EntryPoint = "randomx_alloc_cache", CallingConvention = CallingConvention.Cdecl)]
    private static extern IntPtr alloc_cache(RandomX.randomx_flags flags);

    [DllImport("librandomxscash", EntryPoint = "randomx_init_cache", CallingConvention = CallingConvention.Cdecl)]
    private static extern IntPtr init_cache(IntPtr cache, IntPtr key, int keysize);

    [DllImport("librandomxscash", EntryPoint = "randomx_release_cache", CallingConvention = CallingConvention.Cdecl)]
    private static extern IntPtr release_cache(IntPtr cache);

    [DllImport("librandomxscash", EntryPoint = "randomx_alloc_dataset", CallingConvention = CallingConvention.Cdecl)]
    private static extern IntPtr alloc_dataset(RandomX.randomx_flags flags);

    [DllImport("librandomxscash", EntryPoint = "randomx_dataset_item_count", CallingConvention = CallingConvention.Cdecl)]
    private static extern ulong dataset_item_count();

    [DllImport("librandomxscash", EntryPoint = "randomx_init_dataset", CallingConvention = CallingConvention.Cdecl)]
    private static extern void init_dataset(IntPtr dataset, IntPtr cache, ulong startItem, ulong itemCount);

    [DllImport("librandomxscash", EntryPoint = "randomx_get_dataset_memory", CallingConvention = CallingConvention.Cdecl)]
    private static extern IntPtr get_dataset_memory(IntPtr dataset);

    [DllImport("librandomxscash", EntryPoint = "randomx_release_dataset", CallingConvention = CallingConvention.Cdecl)]
    private static extern void release_dataset(IntPtr dataset);

    [DllImport("librandomxscash", EntryPoint = "randomx_create_vm", CallingConvention = CallingConvention.Cdecl)]
    private static extern IntPtr create_vm(RandomX.randomx_flags flags, IntPtr cache, IntPtr dataset);

    [DllImport("librandomxscash", EntryPoint = "randomx_vm_set_cache", CallingConvention = CallingConvention.Cdecl)]
    private static extern void vm_set_cache(IntPtr machine, IntPtr cache);

    [DllImport("librandomxscash", EntryPoint = "randomx_vm_set_dataset", CallingConvention = CallingConvention.Cdecl)]
    private static extern IntPtr vm_set_dataset(IntPtr machine, IntPtr dataset);

    [DllImport("librandomxscash", EntryPoint = "randomx_destroy_vm", CallingConvention = CallingConvention.Cdecl)]
    private static extern void destroy_vm(IntPtr machine);

    [DllImport("librandomxscash", EntryPoint = "randomx_calculate_hash", CallingConvention = CallingConvention.Cdecl)]
    private static extern void calculate_hash(IntPtr machine, byte* input, int inputSize, byte* output);

    [DllImport("librandomxscash", EntryPoint = "randomx_calculate_commitment", CallingConvention = CallingConvention.Cdecl)]
    private static extern void calculate_commitment(byte* input, int inputSize, byte* randomXHash, byte* output);
    ...
    public static void CreateSeed(string realm, string seedHex,
        RandomX.randomx_flags? flagsOverride = null, RandomX.randomx_flags? flagsAdd = null, int vmCount = 2)
    {
        lock(realms)
        {
    ...
    public static void CalculateHash(string realm, string seedHex, ReadOnlySpan<byte> data, Span<byte> result)
    {
        ...
        if(ctx != null)
        {
            ...
            try
            {
                ...
                messageBus?.SendTelemetry("RandomXSCash", TelemetryCategory.Hash, sw.Elapsed, true);
            }
    ...
    public static void CalculateCommitment(ReadOnlySpan<byte> data, ReadOnlySpan<byte> solution, Span<byte> result)
    {
        Contract.Requires<ArgumentException>(solution.Length >= 32);
        Contract.Requires<ArgumentException>(result.Length >= 32);
        ...
        fixed (byte* input = data)
        {
            fixed (byte* randomXHash = solution)
            {
                fixed (byte* output = result)
                {
                    calculate_commitment(input, data.Length, randomXHash, output);
