...
public static unsafe class EtcHash
{
    ...
    [DllImport("libetchash", EntryPoint = "ethash_light_delete_export", CallingConvention = CallingConvention.Cdecl)]
    ...
    [DllImport("libetchash", EntryPoint = "ethash_full_delete_export", CallingConvention = CallingConvention.Cdecl)]
    ...
    /// <param name="nonce">The nonce to pack into the mix</param>
    /// <returns>an object of ethash_return_value_t holding the return values</returns>
    [DllImport("libetchash", EntryPoint = "ethash_full_compute_export", CallingConvention = CallingConvention.Cdecl)]
    ...
    /// </summary>
    /// <param name="handle">The full handler to free</param>
    [DllImport("libetchash", EntryPoint = "ethash_full_dag_export", CallingConvention = CallingConvention.Cdecl)]
    ...
    /// </summary>
    /// <param name="handle">The full handler to free</param>
    [DllImport("libetchash", EntryPoint = "ethash_full_dag_size_export", CallingConvention = CallingConvention.Cdecl)]
    ...
    /// </summary>
    /// <param name="handle">The full handler to free</param>
    [DllImport("libetchash", EntryPoint = "ethash_get_seedhash_export", CallingConvention = CallingConvention.Cdecl)]
    public static extern ethash_h256_t ethash_get_seedhash(ulong block_number);

    /// <summary>
    /// Get the default DAG directory
    /// </summary>
    [DllImport("libetchash", EntryPoint = "ethash_get_default_dirname_export", CallingConvention = CallingConvention.Cdecl)]
