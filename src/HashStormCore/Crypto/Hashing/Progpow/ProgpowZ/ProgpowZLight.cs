...
namespace HashStormCore.Crypto.Hashing.Progpow.ProgpowZ;

[Identifier("progpowz")]
public class ProgpowZLight : IProgpowLight
{
    ...
    public string AlgoName { get; } = "ProgPowZ";
    ...
    {
        var epoch = block / ZanoConstants.EpochLength;
        Cache result;
