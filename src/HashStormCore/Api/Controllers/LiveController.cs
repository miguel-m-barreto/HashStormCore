// HashStormCore/src/HashStormCore/Api/Controllers/LiveController.cs
using System;
using System.Net;
using Microsoft.AspNetCore.Http;
using Microsoft.AspNetCore.Mvc;
using HashStormCore.Api.Responses.Live;
using HashStormCore.Configuration;
using HashStormCore.Extensions;
using HashStormCore.Live;
...
public class LiveController : ControllerBase
{
    ...
    private double DiffToHashrate(PoolConfig poolCfg, double diffSum, int windowSec, IMiningPool poolInst)
    {
        ...
        // Fallback to classic HashStormCore approach
