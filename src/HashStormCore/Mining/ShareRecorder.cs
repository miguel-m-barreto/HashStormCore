// HashStormCore/src/HashStormCore/Mining/ShareRecorder.cs
...
using Share = HashStormCore.Blockchain.Share;
...
public class ShareRecorder : BackgroundService
{
    ...
    private static void WriteRecoveryFileheader(TextWriter writer)
    {
        ...
        writer.WriteLine("# HashStormCore -c <path-to-config> -rs <path-to-this-file>\n");
    }
